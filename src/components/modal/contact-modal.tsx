...
export function ContactModal() {
	...
	return (
		<>
			<button
				type="button"
				className="accountButton px-8 py-4 w-80 flex items-center justify-between bg-slate-300 rounded-full shadow-shape text-slate-950 hover:bg-slate-500 hover:text-zinc-200 transition duration-400 font-medium text-xl"
